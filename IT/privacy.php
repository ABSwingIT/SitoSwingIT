...
?>
        <section class="inner-hero fade-in">
          ...
          <p class="inner-subtitle">
            ...
            degli utenti che consultano il sito Swing:IT – Software Engineering
            Italia S.R.L.
          </p>
        </section>
        ...
        <section class="content fade-in">
          <div class="iub_header">
            ...
            Catania</p>
            <p><b>Indirizzo email del Titolare:</b> info@softwareengineering.it</p>
            </div>
            <div class="one_line_col">
            <h2>Tipologie di Dati raccolti</h2>
            <p style="text-align: justify;">Il Titolare non fornisce una lista di tipologie di Dati Personali raccolti.</p>
            <p style="text-align: justify;">Altri Dati Personali raccolti potrebbero essere indicati in altre sezioni di questa privacy policy o mediante testi informativi visualizzati contestualmente alla raccolta dei Dati stessi.<br />
            ...
            <p style="text-align: justify;">L'Utente si assume la responsabilità dei Dati Personali di terzi pubblicati o condivisi mediante questa Applicazione e garantisce di avere il diritto di comunicarli o diffonderli, liberando il Titolare da qualsiasi responsabilità verso terzi.</p>
            </div>
            <div class="one_line_col">
            <h2>Modalità e luogo del trattamento dei Dati raccolti</h2>
            <h3>Modalità di trattamento</h3>
            <p style="text-align: justify;">Il Titolare tratta i Dati Personali degli Utenti adottando le opportune misure di sicurezza volte ad impedire l’accesso, la divulgazione, la modifica o la distruzione non autorizzate dei Dati Personali.<br />
            ...
            <p style="text-align: justify;">I Dati Personali dell’Utente possono essere utilizzati da parte del Titolare in giudizio o nelle fasi propedeutiche alla sua eventuale instaurazione per la difesa da abusi nell'utilizzo di questa Applicazione o dei servizi connessi da parte dell’Utente.<br />
            ...
            <p style="text-align: justify;">Il Titolare del Trattamento dei Dati è responsabile per questa privacy policy, redatta partendo da moduli predisposti da Iubenda e conservati sui suoi server.</p>
            </div>
            <h1>Riferimenti Legali</h1>
            ...
            <h4>Utente</h4>
            <p style="text-align: justify;">L'individuo che utilizza questa Applicazione, che deve coincidere con l'Interessato o essere da questo autorizzato ed i cui Dati Personali sono oggetto del trattamento.</p>
            <h4>Interessato</h4>
            ...
            <p style="text-align: justify;">Lo strumento hardware o software mediante il quale sono raccolti i Dati Personali degli Utenti.</p>
            <hr />
            ...
            <p style="text-align: justify;">Questa informativa privacy riguarda esclusivamente questa Applicazione.</p>
        </section>
