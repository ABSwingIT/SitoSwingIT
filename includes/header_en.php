  ...
  <body>
    <div class="page-wrapper">
      ...
      <div class="header-inner">
          ...
          <nav class="main-nav">
            <a href="<?php echo $path; ?>index_en.php" class="<?php echo($page == 'home') ? 'active' : ''; ?>">Home</a>
            <a href="<?php echo $path; ?>EN/chi-siamo_en.php" class="<?php echo($page == 'about') ? 'active' : ''; ?>">About</a>
            <a href="<?php echo $path; ?>EN/engineering_en.php" class="<?php echo($page == 'engineering') ? 'active' : ''; ?>">Engineering</a>
            <a href="<?php echo $path; ?>EN/prodotti_en.php" class="<?php echo($page == 'products') ? 'active' : ''; ?>">Products</a>
            <a href="<?php echo $path; ?>EN/tecnologie_en.php" class="<?php echo($page == 'technologies') ? 'active' : ''; ?>">Technologies</a>
            <a href="<?php echo $path; ?>EN/ricerca-innovazione_en.php" class="<?php echo($page == 'research') ? 'active' : ''; ?>">R&I</a>
            <a href="<?php echo $path; ?>EN/finanziamenti_en.php" class="<?php echo($page == 'funding') ? 'active' : ''; ?>">Funding</a>
            <a href="<?php echo $path; ?>EN/contatti_en.php" class="<?php echo($page == 'contacts') ? 'active' : ''; ?>">Contacts</a>
            <a href="<?php echo $path; ?>EN/lavora-con-noi_en.php" class="<?php echo($page == 'careers') ? 'active' : ''; ?>">Careers</a>
            <a href="<?php echo $path; ?>EN/privacy_en.php" class="<?php echo($page == 'privacy') ? 'active' : ''; ?>">Privacy</a>
          </nav>
